...
class Fed_server(Process):
    ...
    def __init__(
        ...
        test_data, test_label, state_list=None, state_dict_list=None, size_per_client=None
        ):
        ...
        for client_i in range(self.num_clients):
            ...
            backbone = init_per_network(backbone, size_per_client[client_i])
...
class Fed_client(Process):
    ...
    def __init__(
        self, init_network, criterion, config, per_client_data, 
        per_client_label, idx_per_client_train,
        test_data, test_label, state_list=None, state_dict_list=None, idx=None, size_per_client=None
        ):
