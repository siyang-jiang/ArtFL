...
"""
Script for balanced centralized training (train only a global model). 
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', default="config/central_bal.yaml", type=str)
    parser.add_argument("--exp_name", default="central_bal", type=str, help="exp name")
